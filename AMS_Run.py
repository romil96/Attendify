...
def manually_fill():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                with open(csv_name, "w") as csv_file:
                    ...
                    csv_writer.writerow(
                        [i[0] for i in mycursor.description])  # write headers
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"./Manually Attendance/-------Check atttendance-------"')
    ...
    SUB_ENTRY = tk.Entry(sb, width=20, bg="yellow",
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"./Attendance/-------Check atttendance-------"')
    ...
    tx = tk.Entry(windo, width=20, bg="yellow",
                  fg="red", font=('times', 23, ' bold '))
...
def admin_panel():
    ...
    def log_in():
        ...
        if username == 'admin':
            if password == 'admin':
                ...
                Nt.configure(text=valid, bg="red", fg="black",
    ...
    un_entr = tk.Entry(win, width=20, bg="yellow", fg="red",
                       font=('times', 23, ' bold '))
    ...
    pw_entr = tk.Entry(win, width=20, show="*", bg="yellow",
                       fg="red", font=('times', 23, ' bold '))
...
message = tk.Label(window, text="Face Attendance ", bg="white", fg="black", width=50,
...
lbl = tk.Label(window, text="Enter Enrollment", width=20, height=3,
...
clearButton = tk.Button(window, text="Clear", command=clear, fg="black", bg="gray",
                        width=10, height=1, activebackground="Red", font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear", command=clear1, fg="black", bg="gray",
                         width=10, height=1, activebackground="Red", font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

AP = tk.Button(window, text="Check Register students", command=admin_panel, fg="black",
               bg="pale goldenrod", width=19, height=1, activebackground="Red", font=('times', 15, ' bold '))
AP.place(x=990, y=500)

takeImg = tk.Button(window, text="Take Images", command=take_img, fg="black", bg="pale green",
                    width=20, height=3, activebackground="Red", font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images", fg="black", command=trainimg, bg="khaki1",
                     width=20, height=3, activebackground="Red", font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendance", fg="black", command=subjectchoose,
               bg="alice blue", width=20, height=3, activebackground="Red", font=('times', 15, ' bold '))
FA.place(x=690, y=500)

#quitWindow = tk.Button(window, text="Manually Fill Attendance", command=manually_fill  ,fg="black"  ,bg="thistle"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
